...
# The Golden Dataset: 10 Active Tests (40 Commented Out)
EVALUATION_DATASET = [
    ...
    ("Oatmeal for breakfast, 250 cals", "log_food", {"food_name": "oatmeal for breakfast", "calories": 250}),
    ...
    # --- 🏋️ FITNESS: WORKOUT LOGGING (COMMENTED OUT) ---
    ...
    # ("Ran 5k on the treadmill in 25 minutes", "log_workout", {"exercise_type": "running", "sets": 1, "reps": 0, "duration_minutes": 25}),    
    # ("Cycled for 45 mins", "log_workout", {"exercise_type": "cycling", "sets": 1, "reps": 0, "duration_minutes": 45}),
    ...
    # ("Bench press 5x5 took me 20m", "log_workout", {"exercise_type": "bench press", "sets": 5, "reps": 5, "duration_minutes": 20}), 
    ...
    # --- 📋 FITNESS: COACHING & PLANS (COMMENTED OUT) ---
    ...
    # --- ⚙️ SYSTEM: PROFILE MANAGEMENT (COMMENTED OUT) ---
    ...
    # --- 📊 SYSTEM: ANALYTICS & STATUS (COMMENTED OUT) ---
    ...
    # --- 🚫 EDGE CASES: INTENT MISMATCH (COMMENTED OUT) ---
    # ("I am thinking about going to the gym.", None, {}), 
    # ("I saw a recipe for a 500 calorie burger, looks good.", None, {}), 
    # ("My friend lifted 300 lbs today for 5 reps.", None, {}), 
    # ("What should I eat for dinner?", None, {}), 
    # ("Do you think 1000 calories a day is healthy?", None, {}), 

    # --- 💬 CONVERSATIONAL & OUT-OF-BOUNDS (COMMENTED OUT) ---
